...
def _get_BERT_sentence_representation(sentence, model, tokenizer, device):
...
def _get_representation_dict(corpus, model, tokenizer):
  ...
  for sentence in corpus:
    dic[sentence] = _get_BERT_sentence_representation(sentence, model, tokenizer, device)
  return dic
...
def _get_closest_from_a_sentence(sentence, model, tokenizer, representation_dict):
  ...
  for sent in representation_dict:
    score = _get_torch_tensor_sim(sent_rep, representation_dict[sent])
